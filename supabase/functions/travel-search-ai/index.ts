...
Deno.serve(async (req) => {
    ...
    try {
        ...
        if (!body?.type || (body.type !== "flight" && body.type !== "hotel")) {
            return new Response(JSON.stringify({ ok: false, error: "type must be 'flight' or 'hotel'" }), {
