    ...
    <div className="relative h-screen w-full bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <WorldMap
          ...
          heldVisas={heldVisas}
          userPassportCode={stats.userPassport?.code}
      ...
      <button
        ...
        className="absolute bottom-24 right-4 z-50 w-12 h-12 rounded-full bg-white text-black shadow-xl flex items-center justify-center hover:bg-gray-100 transition-colors"
      >
        {showContent ? <X className="w-6 h-6" /> : <LayoutGrid className="w-6 h-6" />}
      </button>

      {/* Content Overlay */}
      {showContent && (
        <div className="absolute inset-0 z-40 bg-black/90 backdrop-blur-md overflow-y-auto animate-fade-in custom-scrollbar">
          <div className="container mx-auto px-4 pt-24 pb-32 space-y-6">
            <GeoPassport />
